...
| 版数 | 日付 | コミット | 内容 | 担当 |
|------|------|---------|------|------|
| 1.0 | 2026-05-05 | 3000a53 | 初版（軽量 Stage 2 設計書）。対話でボトムナビ化方針確定済みのため Stage 1 は省略 | Claude Code |
| 1.1 | 2026-05-05 | 3000a53 | 実装完了。タスク #2-#8 を ✅ に更新、全体ステータスを 🟢 完了 へ。code-review (高/中 0 件 / 低 3 件メモ) / browser-test (全 13 項目合格) / build OK。設計書 §3-5 を実装に合わせて更新（sticky 撤去を明記） | Claude Code |
