...
| 1.4 | 2026-05-06 | (未確定) | sync-check で発見した Phase 10.2 lists API 3 本 (GET/PUT /api/sync/lists, POST /api/sync/lists/merge) の対応表欠落を補正。`useSetsStore.remapListIds` の正確なシグネチャ（Record 形式）をフック一覧に明記 | Claude Code |
